...
public class AllCoinActivity extends AppCompatActivity implements AllCoinAdapter.AllCoinAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_coin);
        ...
        mAdapter = new AllCoinAdapter(this, contactList, this);
    ...
    private void changeStatusBarColor(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            getWindow().setStatusBarColor(getResources().getColor(R.color.green_800, this.getTheme()));
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(getResources().getColor(R.color.green_800));
        }
    }
        ...
        JsonArrayRequest request = new JsonArrayRequest(URL,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        List<AllCoin> items = new Gson().fromJson(response.toString(), new TypeToken<List<AllCoin>>() {
                        }.getType());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_allcoin, menu);
